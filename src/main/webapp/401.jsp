...
<%@ include file="/application/modules/common/init.jsp"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
  <head>
    <title>访问拒绝</title>
    <jsp:include page="/application/modules/common/meta.jsp" flush="true"/>
	<jsp:include page="/application/modules/common/style.jsp" flush="true"/>
  </head> 
  <body>
    ...
    <jsp:include page="/application/modules/common/script.jsp" flush="true" />
