$(function(){
	...
	$("#roleList").jqGrid({
	    ...
	    colModel : [   
			{name:"roleId",index:"role_id",label : "角色ID",width:'100%',align:"center", key:true,hidden:true},
	      	{name:"name",index:"name",label : "角色名",width:'100%',sortable:true,align:"center"},
	      	{name:"description",index:"description",label : "角色描述",width:'100%',sortable:false,align:"center"},
	      	{name:"setup",label : "配&nbsp;置",width:'100%',sortable:false,align:"center" }
		 ],
	    pager: "#roleListPager",	    
	    sortname: "role_id",
	    sortorder: "asc",
