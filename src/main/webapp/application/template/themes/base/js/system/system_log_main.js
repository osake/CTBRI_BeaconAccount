$(function(){
	...
	$("#logList").jqGrid({
	    ...
	    colModel : [   
			{name:"user",index:"user",label : "用户",width:'15%',align:"center"},
			{name:"discription",index:"discription",label : "用户姓名",width:'15%',align:"center", key:true},
	      	{name:"ip",index:"ip",label : "IP地址",width:'15%',sortable:true,align:"center"},	      	
	        {name:"date",index:"date",label : "时&nbsp;间",width:'15%',sortable:true,align:"center"},
	        {name:"action",index:"action",label : "行&nbsp;为",width:'15%',sortable:false,align:"center"},
	        {name:"module",index:"module",label : "所属模块",width:'15%',sortable:false,align:"center" }
		 ],
	    pager: "#logListPager",	    
	    sortname: "date",
	    sortorder: "desc",
