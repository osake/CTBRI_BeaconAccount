...
<%-- 			<div class="menu_list">基础平台</div>
			...
			<div class="menu_list">学院工资</div>
			<dl id="menu4">
				<dt>
					<div class="icon1"
						onClick="Menu('<%=modulesPath%>salary/schoolsalary_main.jsp');">工资管理</div>
				</dt>
				<dt>
					<div class="icon2"
						onClick="Menu('<%=modulesPath%>salary/staffsalary_main.jsp');">工资查看</div>
				</dt>
			</dl>
