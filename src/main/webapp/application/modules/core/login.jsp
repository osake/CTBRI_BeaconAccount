...
<html>
<head>
	<title>灯塔大数据平台对账系统</title>
	<jsp:include page="../common/meta.jsp" flush="true"/>
	<jsp:include page="../common/style.jsp" flush="true"/>
</head>
<body class="login_bodyBg">
<div class="login_bg">
	<form id="loginForm" method="POST" action="j_spring_security_check" style="width:100%;">
    <table class="login">
      <tr>
        ...
        <td class="t_l">
        <span class="tip">
        	${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message!="账号不存在！" ? '' : '无此账号！'}
        	${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message!="账号被冻结！" ? '' : '账号冻结！'}
        	${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message!="账号被废弃！" ? '' : '账号废弃！'}
        	${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message!="Maximum sessions of 1 for this principal exceeded" ? '' : '已登录！'}
        </span></td>
      </tr>
      <tr>
        <td class="t_r">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</td>
        ...
        <td class="t_l">
        <span class="tip">
        	${sessionScope['SPRING_SECURITY_LAST_EXCEPTION'].message!="账号密码错误！" ? '' : '密码错误！'}
        </span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <div class="company">版权所有: 中国电信股份有限公司北京研究院</div>
</div>
