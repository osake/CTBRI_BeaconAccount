...
<div class="section">
	...
	<div class="portlert-form-list">
		...
		<div class="portlert-form-row">
			...
			<div class="portlert-form-collection">
				<select id="modify_type" name="type" size="1" class="portlert-form-input-field" >
	            	...
	            	<option value='prouser'>省公司用户</option>
         	    </select>
		...
		<div class="portlert-form-row">
			...
			<div class="portlert-form-collection">
				<select id="roleSelectL" multiple="multiple" name="role" size="8" style="float:left;width:185px;height:150px;">
				</select>
				...
				<select id="roleSelectR" multiple="multiple" name="roleSelectR" size="8" style="float:left;width:185px;height:150px;">
				</select>
				<span class="portlert-form-msg-alert">&nbsp;</span>
			</div>
	    </div>		
