...
public class DepartmentAction extends JqGridBaseAction<DepartmentDTO> {
	...
	@ResponseBody
	public List<DepartmentAndInfo> getDepartmentTreeList() throws Exception {
	...
	@ResponseBody
	public Map<Object,Object> modifyDepartment(HttpServletRequest request , DepartmentAndInfo dtoDepartInfo) {

		Map<Object,Object> resultMap = new HashMap<Object,Object>();
		try {
			departmentService.modifyDepartment(dtoDepartInfo);
			resultMap.put("result", "success");
			resultMap.put("identity", dtoDepartInfo);
		} catch (Exception e) {
			e.printStackTrace();
			resultMap.put("result", "failure"); 
		}
